...
type PostAdminBookingResourcePricingType = {
  booking_resource_pricing_config: Omit<
    BookingResourcePricingConfigType,
    "id" | "booking_resource" | "product_variant_id"
  >;
...
export async function POST(
  ...
  const bookingResourceWithPrices =
    await bookingModuleService.retrieveBookingResource(req.params.id, {
